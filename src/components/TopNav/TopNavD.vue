<template>
  <nav class="v-nav-header" :class="!isOpened ? 'v-nav-header--closed' : null">
    <div class="v-nav-header__burguer-icon">
      <el-tooltip :content="isOpened ? 'Recolher menu' : 'Abrir menu'" placement="right" effect="vert tooltip-icon">
    ...
    <div class="v-nav-header__actions">
      <!-- Buttons Apps -->
      <div>
        <el-tooltip content="Aplicações" placement="bottom" effect="vert tooltip-icon" show-after="1500">
          <div href="#" class="button-apps" :class="{ isActive: boxAppsVisible }" @click="handleActionsApps"
